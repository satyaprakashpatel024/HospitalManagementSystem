...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    Page<Patient> findByBloodGroup(Pageable pageable, @Param("bloodGroup") BloodGroupType bloodGroup);
    ...
    Page<Patient> findWhoBornAfterDate(@Param("date") LocalDate date, Pageable pageable);
    ...
    Page<BloodGroupCountRespDTO> findPatientCountByBloodGroup(Pageable pageable);
    // native query
    ...
    int updatePatientDetailsById(@Param("name") String name, @Param("id") Long id);

    Page<Patient> findByDobBetween(Pageable pageable, LocalDate startDate, LocalDate endDate);
